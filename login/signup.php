              ...
              <div class="col-lg-12 p-5">
                ...
                <div class="p-5">
                  ...
                  <img src="logo.svg" class="img-fluid" alt="" style='margin-top: 10px;'><br><br>
                    <h1 class="h4 text-gray-900 mb-4">Register New!</h1>
                  </div>
                  <form class="user" id='submit'>
                    ...
                    <div class="form-group text-center"><span class="form-error"></span>
                      <input type="password" name='password' class="form-control form-control-user password" placeholder="Password">
					</div>
					<div class="form-group text-center"><span class="form-error"></span>
                      <input type="password" name='confirm' class="form-control form-control-user confirm" placeholder="Confirm">
                    </div>
                ...
                <div class="text-center">Already A User  <a href="login.php"><u>Click Here</a></u> To  Sign In</div>
...
$('#submit').submit(function(event){
	...
	if(result.length != 0){ //set error to empty
      result = [];
		...
		formAjax(data, 'action/signup.php', function(out){
			if(out == 'success'){
